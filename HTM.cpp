...
void HTM::HipVec(double L1,double L2,double A,double B, double L, double M, double K, int* vx, int* vy, int* vz){
        //LMK is origin values, L1 length of rod 1, L2 length of rod 2, A,B is angles of pot a,b
        double x1 = 0;
        double y1 = 0;
        double z1 = 0;
...
void HTM::PTM4Read(int P1,int P2,int P3,int P4,int* A1, int*A2, int*A3, int*A4){
    float angle1 = 0;
    float angle2 = 0;
    float angle3 = 0;
    float angle4 = 0;
