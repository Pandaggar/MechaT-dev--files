...
int AngleB(double x, double y){
    double BX = QuadXY(x,y);
    double B = 0;

  
    if (BX == 1){
        B = abs(45-(ABVS(x,y,1,-1)));
    }  
    else if(BX == 2){
        B = (ABVS(x,y,1,-1))+45;
    }
    else if(BX == 3){
        B = abs(45-(ABVS(x,y,-1,-1)))+90;
    }
    else if(BX == 4){
        B = (ABVS(x,y,1,-1))+135;
    }
    else if(BX == 5){
        B = abs(45-(ABVS(x,y,-1,1)))+180;
    }
    else if (BX == 6){
        B = (ABVS(x,y,-1,1))+225;
    }
    else if (BX == 7){
        B = abs(45-(ABVS(x,y,1,1)))+270;
    }
    else if (BX == 8){
        B = ABVS(x,y,1,1)+315;
    }
